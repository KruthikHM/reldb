...
/*
RELEASE_ID(primarykey)	POD	RELEASETYPE	DESCRIPTION	IMPACT	IMPACTAREA
RELEASESTATUS	DOP	typeofrelease	PRLINK	RELEASEDATE	QA

ReleaseID	Item	POD	TypeOfRelease	TechPR Signoff	SQL APPROVAL
HeavySQL ALTER	stageQA signoff	IntegrationQA signoff	ROLLOUT PERCENTAGE	Requires BAR	BAR DATE
 */

public class ReleaseTableEntity {
...
//    private Date dop;
    ...
    private int roll_out_percentage;
    ...
    @Column(nullable = true)
    public URL getPrlink() {
        return prlink;
    }

    public void setPrlink(URL prlink) {
        this.prlink = prlink;
    }
    ...
    @Column(nullable = true)
    public int getRoll_out_percentage() {
        return roll_out_percentage;
    }

    public void setRoll_out_percentage(int roll_out_percentage) {
